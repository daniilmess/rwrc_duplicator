...
void setup() {
  ...
  attachInterrupt(0, int0, LOW); // при нажатии кнопки срабатывает 0-е прерывание, обработчик прерывания (ISR) - функция int0()
  ...
  if (Serial.available() > 0) {
    ...
    switch ( com ) {
      ...
      case 'm': {
        ...
        char inputNum = 2; // Порядковый номер вводимого символа (от 0 до 15). Начинаем вводить со 2-го символа, т.к. 0-ой и 1-ый - фиксированные.
